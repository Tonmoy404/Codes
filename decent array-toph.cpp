/**
    ...
    Approach: According to the statement, the friends array must be descending order.
    For that reason the array needs to be sorted in ascending order because  it full fills
    the condition "For all i(1≤ i≤ N), Fi = An - Ai;
    so, I just checked the order of that array.
