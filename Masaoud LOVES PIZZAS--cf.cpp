/**
    ...
    Approach: Firstly, the values of Ai can be counted as a group.
        Masaoud can take until the sum reaches X.
        If the sum is greater than X, then to make a new group
        some previous elements need to be discarded.
        To find the total groups that Masaoud can choose, we just need
        .
*/
